        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchingScore = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinAttendancePercent = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EnrollmentRequests_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EnrollmentRequests_Employees_ReviewerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_JobPostings_Employees_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_Employees_GeneratedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinProficiency = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobSkills", x => new { x.JobId, x.SkillId });
                    table.ForeignKey(
                        name: "FK_JobSkills_JobPostings_JobId",
                        column: x => x.JobId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EnrollmentRequests_EmployeeId",
                table: "EnrollmentRequests",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EnrollmentRequests_ReviewerId",
                table: "EnrollmentRequests",
                column: "ReviewerId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Attendances_CourseSessions_SessionId",
                table: "Attendances",
                column: "SessionId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Attendances_Employees_RecordedBy",
                table: "Attendances",
                column: "RecordedBy",
                principalTable: "Employees",
                principalColumn: "UserId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Courses_Employees_CreatorId",
                table: "Courses",
                column: "CreatorId",
                principalTable: "Employees",
                principalColumn: "UserId",
