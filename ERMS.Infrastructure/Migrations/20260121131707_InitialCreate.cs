        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxJobPostings = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanySize = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enterprises_SubscriptionPlans_CurrentSubscriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WithdrawReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillMatchScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    ExperienceMatchScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    EducationMatchScore = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    SkillMatchDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExperienceMatchDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HighestEducation = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    JobSearchStatus = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterviewMethod = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    MeetingPassword = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    SelectedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Interviews_Users_SelectedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfferLetterUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CandidateResponse = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CandidateRespondedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NegotiationNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RecruitmentPlans_Users_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_RecruitmentPlans_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ExperienceLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlanDetails_Users_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PlanDetails_Users_RequestedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_JobPostings_RecruitmentPlans_RecruitmentPlanId",
                        column: x => x.RecruitmentPlanId,
                        principalTable: "RecruitmentPlans",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JobPostings_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalHistories_EntityType_EntityId",
                table: "ApprovalHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CVScreeningResults_OverallScore",
                table: "CVScreeningResults",
                column: "OverallScore");

            migrationBuilder.CreateIndex(
                name: "IX_CVScreeningResults_Recommendation",
                table: "CVScreeningResults",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_EnterpriseId_DepartmentCode",
                table: "Departments",
                columns: new[] { "EnterpriseId", "DepartmentCode" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enterprises_CurrentSubscriptionId",
                table: "Enterprises",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interviews_SelectedById",
                table: "Interviews",
                column: "SelectedById");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "PlanDetailId",
                unique: true,
                filter: "[PlanDetailId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_RecruitmentPlanId",
                table: "JobPostings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanDetails_ApprovedById",
                table: "PlanDetails",
                column: "ApprovedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecruitmentPlans_Status",
                table: "RecruitmentPlans",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionHistories_PaymentStatus",
                table: "SubscriptionHistories",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Applications_Users_ReferredById",
                table: "Applications",
                column: "ReferredById",
                principalTable: "Users",
                principalColumn: "Id",
